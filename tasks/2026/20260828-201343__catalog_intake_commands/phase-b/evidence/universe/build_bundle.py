...
def main() -> int:
    ...
    for candidate in source["candidates"]:
        ...
        evidence_refs = [
            f"phase-b/evidence/universe/observations.json candidate_id={candidate_id}",
            f"phase-b/evidence/universe/editorial-public-evidence.json candidate_id={candidate_id}",
            f"phase-b/evidence/universe/collisions.json candidate_id={candidate_id}",
        ]
        if handle in ADD:
            decision = ADD[handle]
