...
def main() -> int:
    ...
    owner_statement = (
        ...
        "tasks/2026/20260828-201343__catalog_intake_commands/phase-b/evidence/successor-1/preview.json "
        "and no other catalog changes."
    )
    digest_record = {
        "schema_version": "kz-intake-owner-gate-digest/v1",
        "authority_status": "ABSENT_DO_NOT_APPLY",
        "preview_path": "phase-b/evidence/successor-1/preview.json",
