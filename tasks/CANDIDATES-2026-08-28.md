...
> **Дополнение 2026-08-29.** Этот файл был входом задачи
> [`20260828-201343__catalog_intake_commands`](2026/20260828-201343__catalog_intake_commands/),
> которая цитирует его в HL, TS, ONB и research. Таблицы ниже оставлены в той версии, которую
> задача читала. Её Phase B интегрировала **17 из 23** записей §1 в `data/communities.json`
> (каталог 62 → 82). Ещё не в каталоге — 6: `itbazarkzchannel`, `qaz_qa_vacancies`,
> `nfactorial_school`, `rootway`, `helpfixit`, `sysadm_in_job`.
