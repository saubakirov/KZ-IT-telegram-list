...
|---|------|-------------|------|
| TD-20 | ✅ RESOLVED — the four snapshot-bound tests now pin the reviewed post-apply catalog (82 live entries, digest `b07912bb…`, ref `cc2ac3c`); `pytest scripts/` is green: 45 passed, 465 subtests | [test_catalog_generation.py](scripts/test_catalog_generation.py), [test_kz_intake.py](scripts/test_kz_intake.py) | 2026-08-29 |
